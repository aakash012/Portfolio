        ...
        <div className="row about-wrapper">
          ...
          <div className="col-md-6 col-sm-12">
            <div className="about-wrapper__info">
              ...
              <p className="about-wrapper__info-text">
                {paragraphTwo ||
                  'I have worked on various web frameworks like Angular, Express, Springboot and libraries such as React. I have created multiple projects either in the front-end or the back-end mostly using Javascript, React , Node.js, Express.js, Springboot, PostgresSQL and MongoDB.'
                }
              </p>
              <p className="about-wrapper__info-text">
                {paragraphThree ||
